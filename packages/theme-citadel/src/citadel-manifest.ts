...
export const citadelManifest: ThemeManifest = {
  ...
  assets: {
    basePath: "./assets",
    preload: [
      "tiny-swords/Units/Blue Units/Pawn/Pawn_Idle.png",
      "tiny-swords/Units/Blue Units/Pawn/Pawn_Run.png",
      "tiny-swords/Units/Blue Units/Archer/Arrow.png",
      "tiny-swords/Buildings/Blue Buildings/Barracks.png",
      "tiny-swords/Buildings/Blue Buildings/Castle.png",
      "tiny-swords/Terrain/Resources/Gold/Gold Resource/Gold_Resource.png",
      "tiny-swords/Particle FX/Explosion_01.png",
      "tiny-swords/Terrain/Tileset/Tilemap_color1.png",
      "sfx/peon-ready.ogg",
      "sfx/pigeon-coo.ogg",
      "sfx/coins-clink.ogg",
      "sfx/explosion.ogg",
