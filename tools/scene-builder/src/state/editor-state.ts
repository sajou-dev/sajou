...
function createDefault(): EditorState {
  return {
    ...
    selectedRouteIds: [],
    panelLayouts: {
      "entity-palette": defaultPanelLayout(20, 60, 250, 400),
      "asset-manager": defaultPanelLayout(40, 80, 500, 450),
      "entity-editor": defaultPanelLayout(60, 80, 500, 450),
      inspector: defaultPanelLayout(20, 60, 280, 350),
